...
private:
  ::java::util::SortedSet * __attribute__((aligned(__alignof__( ::java::awt::KeyboardFocusManager )))) delayRequests;

  friend class java_awt_DefaultKeyboardFocusManager$EventDelayRequest;
public:
