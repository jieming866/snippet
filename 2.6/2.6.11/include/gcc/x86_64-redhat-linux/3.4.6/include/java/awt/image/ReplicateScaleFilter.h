...
public:  // actually protected
  virtual jbyteArray replicatePixels (jint, jint, jint, jint, ::java::awt::image::ColorModel *, jbyteArray, jint, jint, jdouble, jdouble, jint);
  virtual jintArray replicatePixels (jint, jint, jint, jint, ::java::awt::image::ColorModel *, jintArray, jint, jint, jdouble, jdouble, jint);
