...
#ifndef __gnu_regexp_REException__
#define __gnu_regexp_REException__
...
class gnu::regexp::REException : public ::java::lang::Exception
{
...
#endif /* __gnu_regexp_REException__ */
