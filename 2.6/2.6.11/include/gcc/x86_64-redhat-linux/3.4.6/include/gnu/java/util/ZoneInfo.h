...
{
public:
  ZoneInfo (jint, ::java::lang::String *, jlongArray, ::java::util::SimpleTimeZone *);
...
private:
  ...
  static const jint SECS_SHIFT = 22L;
  static const jlong OFFSET_MASK = 2097151LL;
  static const jint OFFSET_SHIFT = 43L;
