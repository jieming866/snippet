...
private:
  void showTip ();
  void hideTip ();
  ::java::awt::Point *getGoodPoint (::java::awt::Point *, ::javax::swing::JLayeredPane *, ::javax::swing::JToolTip *, ::java::awt::Dimension *);
  ::java::awt::Component *getContentPaneDeepestComponent (::java::awt::event::MouseEvent *);
  jboolean canToolTipFit (::javax::swing::JToolTip *);
public: // actually package-private
...
private:
  ...
  static ::java::awt::Container *containerPanel;
  static ::javax::swing::JWindow *tooltipWindow;
