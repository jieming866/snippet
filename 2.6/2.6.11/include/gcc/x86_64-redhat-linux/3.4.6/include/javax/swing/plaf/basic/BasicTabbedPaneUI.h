...
public:
  BasicTabbedPaneUI ();
private:
  ::javax::swing::plaf::basic::BasicTabbedPaneUI$ScrollingButton *createIncreaseButton ();
  ::javax::swing::plaf::basic::BasicTabbedPaneUI$ScrollingButton *createDecreaseButton ();
  ::java::awt::Point *findPointForIndex (jint);
public:
