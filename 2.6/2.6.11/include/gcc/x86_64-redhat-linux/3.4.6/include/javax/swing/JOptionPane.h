...
public:
  ...
  virtual ::java::lang::Object *getInitialSelectionValue () { return initialSelectionValue; }
  virtual ::java::lang::Object *getInitialValue () { return initialValue; }
  virtual ::java::lang::Object *getInputValue () { return inputValue; }
  virtual jint getMaxCharactersPerLineCount ();
  virtual ::java::lang::Object *getMessage () { return message; }
  virtual jint getMessageType () { return messageType; }
  virtual JArray< ::java::lang::Object *> *getOptions () { return options; }
  virtual jint getOptionType () { return optionType; }
  static ::java::awt::Frame *getRootFrame ();
  virtual JArray< ::java::lang::Object *> *getSelectionValues () { return selectionValues; }
  virtual ::javax::swing::plaf::OptionPaneUI *getUI ();
  virtual ::java::lang::String *getUIClassID ();
  virtual ::java::lang::Object *getValue () { return value; }
  virtual jboolean getWantsInput () { return wantsInput; }
...
private:
  ...
  static void startModal (::javax::swing::JInternalFrame *, ::javax::swing::JOptionPane *);
  static const jlong serialVersionUID = 5231143276678566796LL;
public:
  static const jint CANCEL_OPTION = 2L;
  static const jint CLOSED_OPTION = -1L;
  static const jint DEFAULT_OPTION = -1L;
  static const jint NO_OPTION = 1L;
  static const jint OK_CANCEL_OPTION = 2L;
  static const jint OK_OPTION = 0L;
  static const jint YES_NO_CANCEL_OPTION = 1L;
  static const jint YES_NO_OPTION = 0L;
  static const jint YES_OPTION = 0L;
  static const jint ERROR_MESSAGE = 0L;
  static const jint INFORMATION_MESSAGE = 1L;
  static const jint PLAIN_MESSAGE = -1L;
...
private:
  ...
  friend class javax_swing_JOptionPane$1;
  friend class javax_swing_JOptionPane$AccessibleJOptionPane;
public:
