...
public:
  ...
  friend class javax_swing_text_AttributeSet$ParagraphAttribute;
  friend class javax_swing_text_AttributeSet$FontAttribute;
  friend class javax_swing_text_AttributeSet$ColorAttribute;
  friend class javax_swing_text_AttributeSet$CharacterAttribute;
