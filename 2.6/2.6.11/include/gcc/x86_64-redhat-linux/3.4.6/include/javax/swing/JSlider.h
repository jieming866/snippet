...
public:
  static ::java::lang::String *INVERTED_CHANGED_PROPERTY;
  static ::java::lang::String *LABEL_TABLE_CHANGED_PROPERTY;
  static ::java::lang::String *MAJOR_TICK_SPACING_CHANGED_PROPERTY;
  static ::java::lang::String *MINOR_TICK_SPACING_CHANGED_PROPERTY;
  static ::java::lang::String *MODEL_CHANGED_PROPERTY;
  static ::java::lang::String *ORIENTATION_CHANGED_PROPERTY;
  static ::java::lang::String *PAINT_LABELS_CHANGED_PROPERTY;
  static ::java::lang::String *PAINT_TICKS_CHANGED_PROPERTY;
private:
