...
public:
  ...
  virtual void setValue (jint, jint, jint, jint);
private:
  ::javax::swing::event::ChangeListener *createChangeListener ();
...
public:
  static ::java::lang::String *BLOCK_INCREMENT_CHANGED_PROPERTY;
  static ::java::lang::String *MODEL_CHANGED_PROPERTY;
  static ::java::lang::String *ORIENTATION_CHANGED_PROPERTY;
  static ::java::lang::String *UNIT_INCREMENT_CHANGED_PROPERTY;
public:  // actually protected
...
private:
  ...
  friend class javax_swing_JScrollBar$1;
  friend class javax_swing_JScrollBar$AccessibleJScrollBar;
public:
