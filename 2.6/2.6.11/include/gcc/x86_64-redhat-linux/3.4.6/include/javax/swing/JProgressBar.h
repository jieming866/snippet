...
public:
  ...
  static ::java::lang::String *STRING_CHANGED_PROPERTY;
  static ::java::lang::String *STRING_PAINTED_CHANGED_PROPERTY;
  static ::java::lang::String *INDETERMINATE_CHANGED_PROPERTY;
private:
