...
public:  // actually protected
  virtual void registerKeyboardAction () { }
...
public:  // actually protected
  ...
  friend class javax_swing_plaf_basic_BasicDesktopPaneUI$OpenAction;
  friend class javax_swing_plaf_basic_BasicDesktopPaneUI$NavigateAction;
  friend class javax_swing_plaf_basic_BasicDesktopPaneUI$MinimizeAction;
  friend class javax_swing_plaf_basic_BasicDesktopPaneUI$MaximizeAction;
  friend class javax_swing_plaf_basic_BasicDesktopPaneUI$CloseAction;
public:
